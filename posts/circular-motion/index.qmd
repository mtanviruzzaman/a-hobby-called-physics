...
In uniform circular motion, the speed is constant. So, the entire acceleration vector consists of the perpendicular component. At a given point on the circle, the velocity vector is tangent to the circular path and the acceleration vector is directed towards the center along a radius. Also, once the speed is fixed, the directional change needed to keep the particle on the circular path is same at every point of the circle, which suggest that the centripetal acceleratioin has a fixed magnitude. 
...
Consequently, for a fixed circular path, the magnitude of the centripetal acceleration is proportional to the square of the speed. If we want to sustain twice the speed, we need four times the centripetal acceleration.
...
## Approach 3: Calculus-proper Derivation
